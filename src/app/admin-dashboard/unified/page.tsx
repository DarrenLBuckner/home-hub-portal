...
export default function UnifiedAdminDashboard() {
  ...
  // State management
  const [activeSection, setActiveSection] = useState<'dashboard' | 'properties' | 'users' | 'pricing' | 'settings' | 'system'>('dashboard');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {/* Users Section */}
        {activeSection === 'users' && permissions?.canAccessUserManagement && (
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-6">👥 User Management</h2>
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="mb-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Platform Users</h3>
                <p className="text-sm text-gray-600">
                  {permissions.canViewAllCountries 
                    ? 'Manage all users across all countries' 
                    : `Manage users in ${permissions.assignedCountryName || 'your assigned country'}`
                  }
                </p>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-left py-3 px-4 font-medium text-gray-900">Admin Level</th>
                    ...
                    {users.map((user) => (
                      <tr key={user.id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4">
                          {user.admin_level && (
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                              user.admin_level === 'super' ? 'bg-purple-100 text-purple-800' :
                              user.admin_level === 'owner' ? 'bg-yellow-100 text-yellow-800' :
                              'bg-gray-100 text-gray-800'
                            }`}>
                              {user.admin_level}
                            </span>
        ...
        {/* Pricing Section */}
        {activeSection === 'pricing' && permissions?.canAccessPricingManagement && (
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-6">💰 Pricing Management</h2>
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="text-center py-8">
                <div className="text-4xl mb-4">💰</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Pricing Controls</h3>
                <p className="text-gray-600 mb-4">
                  {permissions.canEditGlobalPricing 
                    ? 'Manage pricing for all countries and user types'
                    : 'Manage pricing for your assigned country'
                  }
                </p>
        ...
        {/* Settings Section */}
        {activeSection === 'settings' && permissions?.canAccessSettings && (
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-6">⚙️ Admin Settings</h2>
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="text-center py-8">
                <div className="text-4xl mb-4">⚙️</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Personal Settings</h3>
                <p className="text-gray-600 mb-4">Manage your admin profile and preferences</p>
                <Link href="/admin-dashboard/settings">
                  <button className="px-6 py-3 bg-gray-600 text-white font-bold rounded-xl hover:bg-gray-700 transition-colors">
                    Open Settings →
                  </button>
                </Link>
              </div>
