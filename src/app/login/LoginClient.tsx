...
function LoginContent({ initialSiteName }: { initialSiteName: string }) {
...
export default function LoginClient({ initialSiteName }: { initialSiteName: string }) {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}>
      <LoginContent initialSiteName={initialSiteName} />
    </Suspense>
  );
}
