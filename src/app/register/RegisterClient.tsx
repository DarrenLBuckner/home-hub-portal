...
function RegistrationContent({ initialSiteName }: { initialSiteName: string }) {
...
export default function RegisterClient({ initialSiteName }: { initialSiteName: string }) {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <RegistrationContent initialSiteName={initialSiteName} />
    </Suspense>
  );
}
