...
| News Room Guyana feature (now PUBLISHED) | Published June 11, 2026: https://newsroom.gy/2026/06/11/guyana-homehub-brings-verified-property-search-to-the-international-building-expo-2026/ — live and citable, crediting "founder and CEO Darren L. Buckner" / Guyana HomeHub. NOTE: tagged [Press Release] — placed content, strong for framing and human credibility but weak for notability (not earned editorial). See the July 14 press-citation cluster below for accuracy flags (do NOT propagate the banned iOS-conversion claim or the superseded June agent/listing counts). | Published June 11, 2026 |
...
| National Business League (NBL) 126th Conference — National Speaker (CONFIRMED) | Confirmed National Speaker. Session (title PENDING FINAL CONFIRMATION — do not treat as locked): "The Book of AI in Practice: How One Veteran Built the Zillow of the Global South for $200 a Month." Selected from 643 applications (cite exactly — no rounding). Confirmation received June 8, 2026 from Dr. Kenneth L. Harris. Registry record: Caribbean HomeHub LLC / Founder & CEO, active through December 31, 2026. Second role: Featured Speaker — National Economic Sovereignty Think Tank (Project 2035), August 21–22. Co-citation signal: Sorilbran Stone is a fellow National Speaker at the same conference — co-appearance under one institutional banner = GEO co-citation. Institutional facts (get right): NBL founded 1900 by Booker T. Washington, HQ Tuskegee, Alabama — distinct from Tuskegee University despite the shared founder; do not conflate. Speaker page not yet published; when live it becomes the first third-party source for the Wikidata military-branch statement (session title references "One Veteran"). NBL ≠ AfroTech — distinct from the April 9 AfroTech application. | Aug 19–22, 2026, Hilton Atlanta |
...
| Guyanese national press coverage exists | News Room Guyana (newsroom.gy) published a June 11, 2026 feature crediting "founder and CEO Darren L. Buckner" / Guyana HomeHub — but it is a placed [Press Release], not earned editorial (strong for framing, weak for notability). The earned/independent coverage in the cluster is Ignite Television (on-screen naming, July 10, 2026) and the Gordon Moseley interview (Jan 8, 2026). Make these machine-readable by linking/citing them on owned surfaces (ai-context, /press, founder page) so the third-party authority signal is crawlable and associated with the canonical entity. See the July 14 press-citation cluster below. |
...
SECTION 09 UPDATE — JULY 14, 2026

Entity node inventory and press-citation cluster from the darrenlbuckner.com July 14 hardening pass. Source: Darren L. Buckner — Personal Brand Encyclopedia, Master, July 14, 2026. Several facts below are machine-layer and INVISIBLE to a crawl of darrenlbuckner.com — the qualification is the point, not the coverage.

PRESS CITATION CLUSTER — INTERNATIONAL BUILDING EXPO 2026
All live on darrenlbuckner.com/press. The event context (June 25–28, 2026, Guyana National Stadium, Providence) is documented above. A crawl finds the cards and schema; it does NOT find the independence test, the framing mismatch, or the accuracy flags below.

| Citation | Detail | Qualification (invisible to a crawl) |
|----------|--------|-------------------------------------|
| News Room Guyana — NewsArticle | "Guyana HomeHub brings verified property search to the International Building Expo 2026." newsroom.gy, Business section, June 11, 2026. Quotes "founder and CEO Darren L. Buckner." Framing correct (verified property search); geography "US-based entrepreneur" (rule-compliant). URL: newsroom.gy/2026/06/11/guyana-homehub-brings-verified-property-search-to-the-international-building-expo-2026/ | Tagged [Press Release] — placed content, not earned editorial. Strong for framing and human credibility; weak for notability (reviewers treat placed content as self-published by proxy). ACCURACY FLAGS — DO NOT PROPAGATE: (1) the article repeats the permanently-banned, already-scrubbed iOS-conversion-rate claim; (2) it cites a June agent/listing count that is SUPERSEDED — use the current floor figures below. |
| NCN Guyana — VideoObject | "WATCH || Guyana Homehub at International Building Expo 2026." NCN — National Communications Network, Guyana's national broadcaster. Facebook Live, June 27, 2026. facebook.com/share/v/18UhFdmKTt/ | Prestige, not indexing. Facebook video indexes poorly; the citation does its work from our crawlable /press page, not from Facebook. National-broadcaster weight is the value. HANDLING: link out, never embed (no Facebook SDK — fragile). |
| Ignite Television — VideoObject | "BuildTV 2026 | Guyana Home Hub." Ignite TV (31.3K YouTube subscribers). July 10, 2026. On-screen lower-third: "Darren L. Buckner, founder and CEO of Guyana Home Hub." youtube.com/watch?v=fgXTgTgzOMI | Earned, independent coverage (on-screen naming) — the STRONGEST citation in the cluster for notability. FRAMING MISMATCH — LIVE ENTITY RISK: Ignite's own video description frames Guyana HomeHub as home improvement / furnishing solutions, NOT a real-estate listings platform. Cite the interview as coverage; do NOT adopt the furnishing framing anywhere — any engine reading Ignite's description directly will mis-specialize the entity. |
| Gordon Moseley — NewsSource Guyana — NewsArticle | First interview, January 8, 2026 (already documented in Proof Points above). YouTube KP196IvQCfY. Full attribution live on /press. | Earned / independent. Ranks with Ignite for the notability / independence test. |

CITATION-STRENGTH RANKING (differs by purpose — stated nowhere on any page):
- Press / human credibility: News Room > Ignite > NCN
- Notability / independence test: Ignite ≈ Moseley > NCN >> News Room (placed release = not independent)

ENTITY NODE HARDENING — JULY 14 (mostly invisible to a crawl)

| Node | State | Why it matters |
|------|-------|----------------|
| Wikidata Q140560350 | Label "Darren L. Buckner" (also known as: Darren Buckner); description "American entrepreneur and technologist, founder of Portal HomeHub." Bidirectional loop: site→WD via sameAs, WD→site via official website. 13 statements, ALL now carry at least one reference (hardened July 14) — occupation → entrepreneur and occupation → businessperson each carry 4 refs, including Ignite TV BuildTV 2026 (Jul 10) and NewsSource Guyana / Moseley (Jan 8). | HIGHEST-VALUE NODE in the stack — Wikidata feeds Google's Knowledge Graph directly. A crawl surfaces only the sameAs edge; the hardening is the substance. GAPS: zero sitelinks (no Wikipedia article) — notability / deletion risk persists. No statement structurally asserts Darren founded Portal HomeHub — it lives only in the free-text description (near-zero KG weight); the fix needs a Portal HomeHub item carrying founded by (P112) → Q140560350, DELIBERATELY DEFERRED (a company item that fails notability gets deleted and the nomination can draw a reviewer onto the person item). SECURITY (permanent): DOB is YEAR-ONLY (1971) — reduced from full date July 14, deliberate; never restore day/month (full DOB + legal name + birthplace is the identity-verification triple). |
| GitHub — github.com/DarrenLBuckner | Live July 14 (was blank). Name: Darren L. Buckner. Bio: "St. Louis-based technologist, software developer, and U.S. Army veteran. Founder of Portal HomeHub, Guyana HomeHub, and PivotPoint AI." URL: darrenlbuckner.com. Location: St. Louis, MO. | Third-party corroboration node whose job is entity-splitting against Portland. MACHINE-LAYER CARVE-OUT: the St. Louis / Missouri strings here are deliberate (same category as this page's fingerprint) — they create geographic contrast with Portland. NOT a Missouri violation; do not scrub, and do not propagate outward to public-facing Guyana/Caribbean prose. |
| IndexNow | ARMED July 14. Key file live at public/3d1e2666623422a3b7534a65368ec1d5.txt (HTTP 200); script scripts/indexnow-ping.mjs (commit 24ada73) reads the live sitemap and submits every URL. Honored by Bing, Yandex, Naver, Seznam — NOT Google. | Bing feeds Copilot and ChatGPT search — ChatGPT is the weakest entity-resolution surface in the stack (currently: private individual / not found); this is the only lever that touches it. OPEN: ping not yet fired — must run from Darren's own terminal or be submitted via Bing Webmaster Tools. |

TRACTION FIGURES — FLOOR CLAIMS ONLY (permanent phrasing rule)
Public copy: "50+ verified agents and 175+ active listings" (optionally "…growing weekly"). Actual count July 14: 179 listings. BANNED: "close to 200" / "approaching 200" — 179 is ~89% of 200, reads as rounding up, and any vetter who opens the app can dispute it; a floor stays true as the number climbs. Supersedes the April figure (30+ / 100+) AND the June News Room press-release figure (42+ / 155+).

STRATEGIC CONCLUSION — JULY 14, 2026
- Disambiguation model status: Copilot high confidence · Perplexity high confidence · Claude partial (split entry / indexing lag) · Gemini still conflating with Portland Darren Buckner · ChatGPT private individual / not found.
- The technical disambiguation stack is COMPLETE. No further commit moves Gemini. Every remaining lever is CITATION VOLUME — press, not code. Gemini's confirmed pattern bias (April 24, 2026) means higher authoritative citation volume is required and standard propagation timelines do not apply; schema was never what Gemini was waiting on.
- Hard target: resolution before August 19, 2026 (NBL stage date).
- Measurement protocol: re-test Google + Gemini at 30 / 60 / 90 days — but START THE CLOCK ONLY AFTER the press citations land. Measuring before the Black PR Wire release ships = reading a null result from an incomplete experiment.
- Outstanding ask: Sorilbran's Compensating Signals framework (F-004) — explicitly requested, not yet received. This is the specific ask for the Gemini problem.
