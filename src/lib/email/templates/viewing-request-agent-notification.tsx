        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <a href={`mailto:${visitorEmail}?subject=Re: Your Viewing Request for ${propertyTitle}&body=Hi ${visitorName},%0D%0A%0D%0AThank you for your interest in ${propertyTitle}. I'd be happy to arrange a viewing for you.%0D%0A%0D%0AWhen would be a good time for you?%0D%0A%0D%0ABest regards,%0D%0A${listingUserName}`} style={{
                backgroundColor: '#dc2626',
                color: '#ffffff',
                padding: '18px 32px',
                borderRadius: '6px',
